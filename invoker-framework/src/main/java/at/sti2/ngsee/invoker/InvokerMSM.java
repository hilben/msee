...
import at.sti2.ngsee.invoker_api.framework.IInvokerMSM;
...
public class InvokerMSM implements IInvokerMSM {
	...
	/**
	 * @see at.sti2.ngsee.invoker_api.framework.IInvokerMSM#getLoweringSchema()
	 */
	@Override
	public URL getLoweringSchema() { return this.loweringSchema; }

	/**
	 * @see at.sti2.ngsee.invoker_api.framework.IInvokerMSM#getLifingSchema()
	 */
	@Override
	public URL getLifingSchema() { return this.liftingSchema; }

	/**
	 * @see at.sti2.ngsee.invoker_api.framework.IInvokerMSM#getWSDL()
	 */
	@Override
	public URL getWSDL() { return this.wsdl; }
	
	/**
	 * @see at.sti2.ngsee.invoker_api.framework.IInvokerMSM#getSOAPAction()
	 */
	@Override
	public String getSOAPAction() { return this.soapAction; }
	
	/**
	 * @see at.sti2.ngsee.invoker_api.framework.IInvokerMSM#getOperationQName()
	 */
	@Override
