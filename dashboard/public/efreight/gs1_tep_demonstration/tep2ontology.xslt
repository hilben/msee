            ...
            <e:Document rdf:about="#{$id}">
                ...
                <e:hasConsignor>
                    <e:Party>
                        ...
                        <e:hasIdentifier><xsl:value-of select="cac:SenderParty/cac:PartyIdentification/cbc:ID"/></e:hasIdentifier>
                    </e:Party>
                </e:hasConsignor>
                <e:hasConsignee>
                    <e:Party>
                        <e:hasName><xsl:value-of select="cac:ReceiverParty/cac:PartyName/cbc:Name"/></e:hasName>
                        <e:hasIdentifier><xsl:value-of select="cac:ReceiverParty/cac:PartyIdentification/cbc:ID"/></e:hasIdentifier>
                    </e:Party>
                </e:hasConsignee>
                        ...
                        <xsl:for-each select="cac:Consignment/cac:TransportHandlingUnit">
                            <e:containsTransportHandlingUnit>
                                <e:Package>
                                    ...
                                    <e:hasCargoType>
                                        <owl:Thing>
                                            <e:hasStringID><xsl:value-of select=".//cac:GoodsItem/cac:Item/cac:CommodityClassification/cbc:CargoTypeCode"/></e:hasStringID>
                                        </owl:Thing>
                                    </e:hasCargoType>
                                </e:Package>
                            </e:containsTransportHandlingUnit>
