 ...
 *          State: $State$<br>
 */
public class SoapAxisInvoker implements ISOAPInvoker {
	protected static Logger logger = Logger.getLogger(SoapAxisInvoker.class);
	...
	@Deprecated
	@Override
	public String invoke(String _wsdlURL, QName _operationQName,
			String... _inputData) throws AxisFault, MalformedURLException,
			XMLStreamException {
		ServiceClient serviceClient = new ServiceClient();
		Options opts = new Options();
		opts.setTo(new EndpointReference(_wsdlURL));
		/**
		 * TODO: Support SOAPAction values that are different than the operation
		 * qualified name.
		 */
	...
	@Override
	public String invoke(URL _wsdlURL, List<QName> _header, String _soapAction,
			String _inputData) throws AxisFault, XMLStreamException {
		ServiceClient serviceClient = new ServiceClient();
		Options opts = new Options();
