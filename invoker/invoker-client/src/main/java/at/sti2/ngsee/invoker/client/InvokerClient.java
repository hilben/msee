...
public class InvokerClient {
	...
	public static void main(String[] args) throws Exception_Exception,
		...
		Scanner scanner = new Scanner(new FileInputStream(InvokerClient.class
				.getResource("/weather-input.rdf.xml").getFile()));
		try {
		...
		for (int count = 0; count < LOOPS; count++) {
			...
			String responseMessage = service.invoke(serviceID, operationName,
					inputData.toString());
