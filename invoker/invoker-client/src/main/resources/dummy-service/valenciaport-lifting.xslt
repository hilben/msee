<xsl:stylesheet version="2.0"
        ...
        <xsl:variable name="id">
                <xsl:value-of select="/dum:submitFALFormResponse/GeneralDeclarationResponse/ID"/>
        </xsl:variable>

        <xsl:variable name="shipid">
                <xsl:value-of select="/dum:submitFALFormResponse/GeneralDeclarationResponse/shipID"/>
        </xsl:variable>
