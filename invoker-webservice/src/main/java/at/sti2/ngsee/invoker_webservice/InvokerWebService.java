...
import at.sti2.ngsee.invoker.TriplestoreHandler;
import at.sti2.ngsee.invoker.framework.InvokerFactory;
import at.sti2.ngsee.invoker_api.framework.ISOAPInvoker;
import at.sti2.ngsee.invoker_api.framework.ISOAPInvoker.BINDING_TYPE;
...
public class InvokerWebService implements IInvokerEndpoint
{
	...
	public String invoke(@WebParam(name="serviceID")String _serviceID,
		...
		String operationQName = TriplestoreHandler.getOperationQName(_serviceID, _operationName);
		...
		ISOAPInvoker wsdlInvoker = InvokerFactory.createWSDLInvoker();
		String xmlData = wsdlInvoker.invoke(serviceURL, BINDING_TYPE.Automatic, operationQName, serviceData);
		
		// TODO: Lifint the xml Data to RDF.
		String rdfData = xmlData;
		return rdfData;
	}
