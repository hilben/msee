...
public abstract class ServiceImporter {
	...
	public InputStream importServiceToString(String fileName, String serviceDescription, String sourceUri) throws ImporterException {
		String uuid = generateUniqueId();
		return importServiceToString(fileName, serviceDescription, sourceUri, uuid);
	}
	...
	public InputStream importServiceToString(String fileName, String serviceDescription, String sourceUri, String uuid) throws ImporterException {
		if ( null == fileName || fileName.equalsIgnoreCase("") ) {
			throw new ImporterException("File name of service description is null");
		}
		...
		return msmServiceDescriptionStream;
	}
