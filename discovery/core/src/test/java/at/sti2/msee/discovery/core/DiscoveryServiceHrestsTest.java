...
public class DiscoveryServiceHrestsTest extends TestCase {
	...
	public void setUp() throws Exception {
		...
		String serviceDescriptionURL = this.getClass().getResource("/services/hrests1.html")
				.toString();
	...
	public void testSawsdl() throws ServiceRegistrationException, DiscoveryException {
		...
		assertTrue(result.length() > 10); // TODO
	}
	...
	@Test
	public void testGetServiceCategoriesTwoElements() throws IOException,
			ServiceRegistrationException {
		String serviceDescriptionURL = this.getClass()
				.getResource("/services/hrests1With2Categories.html").toString();
		ServiceRegistrationImpl registrationService = new ServiceRegistrationImpl(serviceRepository);
		registrationService.register(serviceDescriptionURL);

		String[] expectedCategories = { "http://msee.sti2.at/categories#business",
				"http://msee.sti2.at/categories#otherbusiness" };
		String[] categories = ((DiscoveryServiceImpl) discoveryService).getServiceCategories();
