...
import at.sti2.msee.invocation.api.webservice.IAvailabilityCheck;
import at.sti2.msee.invocation.api.webservice.IinvocationEndpoint;
...
@WSDLDocumentationCollection(
		@WSDLDocumentation("SESA invocation Component")
	)
@InInterceptors(interceptors = {"at.sti2.msee.invocation.webservice.SOAPInterceptor"})
@InFaultInterceptors(interceptors = {"at.sti2.msee.invocation.webservice.SOAPInterceptor"})
public class invocationWebService implements IinvocationEndpoint, IAvailabilityCheck {
	protected static Logger logger = Logger.getLogger(invocationWebService.class);
	...
	/**
	 * @see at.sti2.msee.invocation_api.invocation#invoke(java.lang.String, java.lang.String)
	 */
	@Override
	@WebMethod
	...
	/**
	 * @see at.sti2.msee.invocation.api.webservice.IAvailabilityCheck#checkAvailability()
	 */
	@WebMethod
	@Override
