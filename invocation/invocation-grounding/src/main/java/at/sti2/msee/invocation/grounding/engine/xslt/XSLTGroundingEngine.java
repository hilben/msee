 ...
 */
package at.sti2.msee.invocation.grounding.engine.xslt;
...
public class XSLTGroundingEngine implements IGroundingEngine {
	...
	/*
	 * (non-Javadoc)
	 * @see at.sti2.msee.invocation_api.grounding.IGroundingEngine#lower(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see at.sti2.msee.invocation_api.grounding.IGroundingEngine#lift(java.lang.String)
	 */
	@Override
