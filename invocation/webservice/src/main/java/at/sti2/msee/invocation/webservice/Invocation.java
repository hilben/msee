...
public interface Invocation extends ServiceInvocation {
	...
	@Override
	@WebMethod
	public String invoke(@WebParam(name="serviceID")String serviceID,@WebParam(name="operationName") String operationName,
			@WebParam(name="inputData")String inputData) throws ServiceInvokerException;
}
