    ...
    <xsl:template match="/ns1:transportInstructionMessage">
        <rdf:RDF>
            ...
            <e:Consignment rdf:about="#{$conid}">
                ...
                <e:hasTotalPackageQuantity>
                    <owl:Thing>
                        <e:hasValue><xsl:value-of select="transportInstruction/transportInstructionConsignment/transportCargoCharacteristics/totalPackageQuantity" /></e:hasValue>
                    </owl:Thing>
                </e:hasTotalPackageQuantity>
                <e:hasTransportEvent>
	                <e:DeliveryTransportEvent>
	                	<e:hasSequenceNumber>
	                		<e:Identifier>
	                			<e:hasNumericalID>
	                				<xsl:value-of select="transportInstruction/transportInstructionConsignment/transportInstructionTransportMovement/sequenceNumber" />
	                			</e:hasNumericalID>
	                		</e:Identifier>
	                	</e:hasSequenceNumber>
	                	<e:hasTypeCode>
	                		<owl:Thing>
	                			<e:hasStringID>
		                			<xsl:value-of select="transportInstruction/transportInstructionConsignment/transportInstructionTransportMovement/transportModeTypeCode" />
	                			</e:hasStringID>
	                		</owl:Thing>
	                	</e:hasTypeCode>
		                <e:hasTransportEvent>
		                    <e:DepartureTransportEvent>
		                    	<e:hasLocation>
		                    		<e:Location>
		                    			<e:hasCityName>
		                    				<xsl:value-of select="transportInstruction/transportInstructionConsignment/transportInstructionTransportMovement/plannedDeparture/logisticLocation/address/city" />
		                    			</e:hasCityName>
		                    		</e:Location>
		                    	</e:hasLocation>
		                    	<e:hasTime>
		                    		<time:TemporalEntity>
		                    			<xsl:value-of select="transportInstruction/transportInstructionConsignment/transportInstructionTransportMovement/plannedDeparture/logisticEventDateTime" />
		                    		</time:TemporalEntity>
		                    	</e:hasTime>
		                    </e:DepartureTransportEvent>
		                 </e:hasTransportEvent>
		                 <e:hasTransportEvent>
		                    <e:ArrivalTransportEvent>
		                    	<e:hasLocation>
		                    		<e:Location>
		                    			<e:hasCityName>
		                    				<xsl:value-of select="transportInstruction/transportInstructionConsignment/transportInstructionTransportMovement/plannedArrival/logisticLocation/address/city" />
		                    			</e:hasCityName>
		                    		</e:Location>
		                    	</e:hasLocation>
		                    </e:ArrivalTransportEvent>
